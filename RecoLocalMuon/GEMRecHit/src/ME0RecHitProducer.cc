...
ME0RecHitProducer::ME0RecHitProducer(const ParameterSet& config){
  ...
  theME0DigiToken = consumes<ME0DigiCollection>(config.getParameter<edm::InputTag>("me0DigiLabel"));  // 20022018
...
void ME0RecHitProducer::produce(Event& event, const EventSetup& setup) {
  ...
  Handle<ME0DigiCollection> digis; // 20022018
  ...
  ME0DigiCollection::DigiRangeIterator me0dgIt; // 20022018
  for (me0dgIt = digis->begin(); me0dgIt != digis->end();
    ...
    const ME0DigiCollection::Range& range = (*me0dgIt).second; //20022018
